...
The latest promoted Practical Shopping Home slice is code SHA `7f4126932713f6844363cf81d9f907d8089cb18f` (`Surface saved exact product context on Home`), carried by docs-bearing promoted ref `f5837026152f642d53357f68aabb760f1de5464e`. Candidate workflow **34056970343** passed for the exact code SHA: Android job **101550525392** (405 shared-core tests, 1,591 Android tests, lint/build, privacy and single signer), browser job **101550525445** (30 tests and Firefox package checks), and release-bundle job **101551302449**. The candidate release artifact digest is `sha256:94584924bd5347846efddf3360ca7a8f3729e8a516a4321d395f29354908ef41`. Milestone workflow **34057860915** and provenance job **101552934416** verified the promoted ref and exact candidate artifact lineage (provenance-copy artifact digest `sha256:01f421178e1147270d46415c0971e794db66e08405c2bea30b23ac7a502e4f26`). Home now composes a small, display-only context from the existing validated Saved exact-product projector. After a confirmed private choice, the relevant row shows its safe label (or says the label is unavailable without leaking an opaque identity) and the action becomes `Change exact product`; if Saved is refreshing, invalid or unresolved, Home removes the old notice. The notice explicitly says it does not alter the fictional sample plan or claim current price, stock or availability. The existing planner/projector, exact money/quantity, evidence, ranking, persistence and no-network boundaries are unchanged. Local verification passed 405 shared-core tests, 1,591 Android tests, 80 Python/catalog tests and 30 browser tests with zero failures or skips; Android lint/debug+release assembly, APK privacy/single-signer, signed 30,000-record catalogs and signed 6,093-location store checks passed. Physical-device ergonomics/accessibility and lawful production Home activation remain open; provider feeds remain blocked pending explicit rights.

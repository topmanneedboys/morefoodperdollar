...
The latest promoted production-Home safety slice is `d8681daea0de046bc24314dd7895aee0467ebc29` (`Guard production Home same-generation request identity`). Candidate workflow **34054460543** passed for the exact SHA: Android job **101543655715** (405 shared-core tests, 1,591 Android tests, lint/build, privacy and single signer), browser job **101543655612** (30 tests and Firefox package checks), and release-bundle job **101544529852**. Milestone workflow **34054815462** and provenance job **101544703003** verified the promoted ref and exact candidate artifact lineage (candidate release artifact digest `sha256:dac250096d8b28331d7f783a92b355cc09ec3f720ed8dc33ba2a4d55f3f5f7a0`; provenance-copy digest `sha256:e20b85b4b15a514bc29ad10c42958849ecfbe2edc04b4fba9d7b97513a814610`). The production Home handoff now retains a bounded, display-free request identity and requires that identity, the projected result and renderer-ready state all match before treating a same-generation replay as a duplicate. Different no-coverage store scopes or display states now fail closed as generation conflicts instead of silently reusing stale content; deterministic regression tests cover both cases. This handoff-only safety slice leaves the existing identity-only catalog, exact planner, evidence and private-observation boundaries unchanged; it adds no price, package quantity, store, availability, evidence, planner, ranking, persistence, networking, demo-data or provider-economics authority. Local verification passed 405 shared-core tests, 1,591 Android tests, 80 Python/catalog tests and 30 browser tests with zero failures or skips; signed 30,000-record GTA/Metro Vancouver catalogs and the signed 6,093-location store directory verified. Physical-device barcode/camera, accessibility and latency review and lawful production Home activation remain open; provider feeds remain blocked pending explicit rights.

...
The latest promoted Home consumer slice is `91b7367a3139050c86b951f2101db48a1cc06936` (`Disclose staple watch candidate store status`), following the prior planned-stop disclosure at `5852e98d11fd973c019fa6f95038bb7be41525af`. Candidate workflow **34011927686** passed for the exact SHA, including release-bundle job **101429658846**; milestone workflow **34012151591** and provenance job **101429716734** verified the promoted ref and exact candidate artifact lineage. Watch My Staples’ private-evidence switch card now presents `Candidate store` plus `Candidate store only — product availability is not confirmed.` Home, Basket, plan-result and share surfaces continue to present assignments as planned stops with the same availability boundary. This is presentation-only and moves no planner/projector, money, evidence, private-memory, catalog, store-directory, ranking or provider authority into a View; fictional demo data remains disclosed. Local verification passed 402 shared-core tests, 1,578 Android tests, 80 Python/catalog tests and 30 browser tests with zero failures or skips; Android lint/build/privacy/single-signer, signed offline catalogs/store directory and candidate release-bundle checks passed. Physical-device confirmation and lawful production Home activation remain open; provider feeds remain blocked pending explicit rights.

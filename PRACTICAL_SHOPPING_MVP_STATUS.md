...
Next engineering slice: implement and regression-test that provider-neutral production coordinator before any Home activation. Do not infer live offers from the identity catalog or location directory, and do not route this through the fictional controller.

...
The latest promoted slice makes Basket’s local-only check-off scope explicit to shoppers. It changes no typed collection state, plan, totals, planner, ranking, pricing, evidence, persistence, clock, notification, network, or View authority; the existing Home extra-stop disclosure and Basket typed eligibility/item-preference context remain intact.

...
The latest promoted slice hardens Basket check-off eligibility to the planner's typed assignment projection. It changes no typed collection state, plan, totals, planner, ranking, pricing, evidence, persistence, clock, notification, network, or View authority; the existing item and preference context for assistive technology remains intact.

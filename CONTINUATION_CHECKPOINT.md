...
The latest promoted slice makes Home’s progressive extra-stop disclosure explicit to assistive technology. It changes no typed collection state, plan, totals, planner, ranking, pricing, evidence, persistence, clock, notification, network, or View authority; the existing Basket typed eligibility and item/preference context remain intact.

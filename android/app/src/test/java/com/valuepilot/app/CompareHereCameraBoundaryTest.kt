...
class CompareHereCameraBoundaryTest {
    ...
    fun cameraCaptureIsUserInitiatedAndReusesBoundedOnDevicePhotoRoute() {
        ...
        assertTrue(source.contains("CompareHerePhotoRecognitionPolicy.begin"))
        assertTrue(source.contains("CompareHerePhotoRecognitionPolicy.complete"))
        assertTrue(source.contains("CompareHerePhotoStopPolicy.begin"))
        assertTrue(source.contains("CompareHerePhotoStopPolicy.complete"))
        assertTrue(source.contains("compare_photo_stopping"))
        assertTrue(source.contains("photoRecognitionState.activeRequestId == null"))

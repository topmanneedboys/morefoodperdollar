...
- category shown as Virtual Malls
- CAD earnings metadata
- broad catalog is useful for Product-vs-Offer, category diversity, price/variant and general-shopping architecture stress testing

Do not infer feed availability from category or earnings. Inspect the advertiser details and terms first.

### 4. West Coast Kids - Canada (CID 5753672) — HIGH PRIORITY FAMILY/PHYSICAL-GOODS SCREEN

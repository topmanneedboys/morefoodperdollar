...
Session 2 should separate model loading, clock, and normalization ports, then create a small `shared-core` KMP module for proven-pure models/contracts/algorithms and golden tests. Browser TypeScript remains independent while consuming matching schemas and fixtures.

...
The latest promoted Practical Shopping Home consumer slice is code SHA `3ed5f7105f2c7d008822202824c3d100289e8a93` (`Clarify bounded barcode handoff capacity`). Candidate workflow **34070119262** passed (405 shared-core tests, 1,619 Android tests, 30 browser tests, lint/build, privacy and release bundle); milestone workflow **34070476754** and provenance job **101586761130** verified the exact promoted SHA and candidate artifact lineage. Candidate bundle digest: `sha256:3019b8be1e71af82c314bea69dba90fddbaed254fa8315f1de67622585a8710e`; provenance-copy digest: `sha256:db4f41e5fb7959695669a1b302fe8234d811989645d43d5a1094653f9089353f`. The barcode handoff copy now explains the next available entry and the 32-entry bound, with deterministic coverage of the final slot and no-overwrite behavior. No ranking, evidence or live-data authority changed. Physical-device handoff/OCR/accessibility/latency validation and lawful production Home activation remain open.
